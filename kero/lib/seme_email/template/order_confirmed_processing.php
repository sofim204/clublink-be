...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body bgcolor="#FFFFFF">
		<table class="head-wrap" bgcolor="#ededed" width="100%" summary="header content">
			<tr>
				<th><h4>Order Confirmed (Processing)</h4></th>
			</tr>
		</table>
						...
						<table width="100%">
							<tr>
								<td>
									...
									<!-- <p>Please prepare the order immediately. Use the "Print Waybill" feature in the app and don't forget to attach the waybill on the packaging!</p> -->
									<p>SellOn is going to email you the "Waybill", please wait a few minutes.</p>
