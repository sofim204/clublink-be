					...
					<div class="content">
						<table width="100%">
							<tr>
								<td>
									<h3>Halo {{fnama}}</h3>
									<p class="lead">Terima kasih telah mengaktifkan akun {{site_name}}.</p>
                  					<p>Anda bisa login {{site_name}} sekarang. Selamat berbelanja bersama kami.</p>
									<p>&nbsp;</p>
									<p>Semoga sukses</p>
									<p>Tim {{site_name}}</p>
								</td>
