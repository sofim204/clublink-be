...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title>(Admin) GoGoX delivery is required manually</title>
	...
	<body bgcolor="#FFFFFF">
		<table class="head-wrap" bgcolor="#ededed" width="100%" summary="header content">
			<tr>
				<th><h4>(Admin) GoGoX delivery is required manually</h4></th>
			</tr>
		</table>
					...
					<div class="content">
						<table width="100%">
							<tr>
								<td>
									<h3>Dear Admin.</h3>
									<p>The Order ID of {{order_id}}({{produk_nama}}) needs to be processed manually on GoGoX dashboard</p>
									<p>due to the lack of longitude and latitude information in the address given.</p>
									<p>&nbsp;</p>
									<p>&nbsp;</p>
									<p>Best wishes</p>
