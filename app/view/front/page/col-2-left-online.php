	...
	<body>
		...
		<div id="page-wrapper" class="page-loading">
			...
			<div class="preloader themed-background">
				<h1 class="push-top-bottom text-light text-center" ><strong>CALYSTA ONLINE</strong><br><small>Loading...</small></h1>
				<div class="inner">
		...
		<script src="<?php echo $this->skins->front; ?>js/pages/ecomDashboard.js"></script>
