...
<img src="<?php echo $this->skins->front; ?>img/background-login.jpg" alt="Login Full Background" class="full-bg animation-pulseSlow">
<!-- END Login Full Background -->
	...
	<div id="login-container" class="animation-fadeIn">
		...
		<div class="login-title text-center">
			<img src="<?php echo base_url(); ?>media/calysta-logo-wide.png" class="img-responsive login-image" />
		</div>
		<!-- END Login Title -->
		...
		<div class="block push-bit">
			...
			<!-- Login Form -->
			<form action="<?php echo base_url("login/proses"); ?>" method="post" id="form-login" class="form-horizontal form-bordered form-control-borderless">
				...
				<div class="form-group form-actions">
					...
					<div class="col-xs-8 text-right">
						<button type="submit" class="btn btn-sm btn-primary"><i id="bsubmit" class="fa fa-angle-right"></i> Login ke Billing</button>
					</div>
				</div>
						<!--
				<div class="form-group">
