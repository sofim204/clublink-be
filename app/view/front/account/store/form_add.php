        ...
        <div class="col-sm-8 col-md-9">
          <div id="alamat_list" class="wijet-profile-main">
              <div class="title m-b-2"><span>
                <i class="fa fa-shopping-cart" aria-hidden="true" style="margin-right: 5px;"></i>BUKA TOKO BARU</span>
              </div>
              <div class="row">
                ...
                <div class="col-xs-12 col-sm-8">
                    <form id="form_toko" action="<?php echo base_url('account/toko'); ?>" method="post" enctype="multipart/form-data">
