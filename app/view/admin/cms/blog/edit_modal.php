...
<!-- end media loading modal -->
<!-- end media-->


<!-- modal variasi -->
<div id="modal_variasi" class="modal fade " tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">

			<!-- Modal Header -->
			<div class="modal-header text-center">
				<h2 class="modal-title">Variasi Produk</h2>
			</div>
			<!-- END Modal Header -->

			<!-- Modal Body -->
			<div class="modal-body">
				<form id="modal_variasi_form">
					<div class="row">
						<div class="col-md-12">
							<label for="modal_variasi_warna_input">Warna</label>
							<input id="modal_variasi_warna_input" class="form-control" />
						</div>
						<div class="col-md-12">
							<label for="modal_variasi_ukuran_input">Ukuran</label>
							<input id="modal_variasi_ukuran_input" class="form-control" />
						</div>
						<div class="col-md-12">
							<br>
							<div class="btn-group pull-right">
								<a id="modal_variasi_simpan" href="#" class="btn btn-info"><i class="fa fa-save"></i> Simpan Variasi</a>
							</div>
						</div>
					</form>
				</div>
