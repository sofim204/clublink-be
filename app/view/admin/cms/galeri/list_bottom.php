...
shTable = jQuery('#shTable').DataTable({
	...
	"bProcessing"		: true,
	"bServerSide"		: true,
	"sAjaxSource"		: "<?php echo base_url("api/galeri/index/"); ?>",
	...
	"fnServerData"	: function (sSource, aoData, fnCallback, oSettings) {
      ...
      fnCallback(response);
      $("#shTable tbody").off("click",'.adelete');
      $("#shTable tbody").on("click",'.adelete',function(e){
        e.preventDefault();
        var c = confirm('Apakah anda yakin?');
        if(c){
          var id = $(this).attr("data-id");
          var url = '<?php echo base_url("api/galeri/del/"); ?>'+id;
