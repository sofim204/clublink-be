...
<div id="page-content">
	...
	<!-- Content -->
	<form id="ftambah" action="<?php echo base_url_admin('ecommerce/flashsale/tambah/'); ?>" method="post" enctype="multipart/form-data" class="" onsubmit="return false;">
		<input type="hidden" id="iproduk_komposisi" name="produk_komposisi" value="{}" />
		<div class="block full row">
			...
			<div class="form-group">
				<div class="col-md-3">
					<label for="ia_company_id">Tersedia Di *</label>
					<select id="ia_company_id" name="a_company_id" class="form-control" required>
						<option value="NULL" data-kode="00">Semua Cabang</option>
						<?php if(isset($cabang)){ foreach($cabang as $cbg){ ?>
						<option value="<?php echo $cbg->id; ?>" data-kode="<?=$cbg->kode?>"><?php echo $cbg->nama; ?></option>
						<?php }} ?>
					</select>
				</div>
				<div class="col-md-3">
					<label for="ib_kategori_id">Kategori *</label>
				...
				<div class="col-md-3">
					<label for="itindakan_oleh">Tindakan Oleh *</label>
					<select id="itindakan_oleh" name="tindakan_oleh" class="form-control" required>
				...
				<div class="col-md-3">
					<label for="iis_asistensi">Butuh Asistensi *</label>
					<select id="iis_asistensi" name="is_asistensi" class="form-control" required>
			...
			<div class="form-group">
				<div class="col-md-3">
					<label class="" for="isku">SKU *</label>
					<input id="isku" type="text" name="sku" class="form-control" minlength="1" placeholder="SKU/kode jasa" required />
				</div>
				<div class="col-md-9">
					<label class="" for="inama">Nama Jasa *</label>
		...
		<div class="block full row">
			...
			<div class="form-group">
				<div class="col-md-4">
					...
					<input id="iharga_jual" type="text" class="form-control" placeholder="harga jual" required />
		...
		<div class="block full row">
			...
			<div class="form-group">
				<div class="col-md-4">
					<label for="ipoin_terapis">Poin Terapis</label>
					<input id="ipoin_terapis" name="poin_terapis" type="text" class="form-control" value="0.0" />
				</div>
			</div>
			<div class="form-group">
				<div class="col-md-4">
					<label for="ipoin_asistensi">Poin Asistensi</label>
					<input id="ipoin_asistensi" name="poin_asistensi" type="text" class="form-control" value="0.0" />
				</div>
			</div>
		</div>
		...
		<div class="block full row">
			...
			<div class="form-group">
				<div class="col-md-3" style="display:none;">
					<label for="iscope">Lingkup</label>
					<select id="iscope" name="scope" class="form-control">
						<option value="all" data-kode="AL">Semua Cabang</option>
						<option value="current_only" data-kode="CO">Cabang Saja</option>
						<option value="current_below" data-kode="CB" style="display:none;">Cabang Ini dan dibawahnya</option>
						<option value="none" data-kode="NN" style="display:none;">Tidak Ada</option>
					</select>
				</div>
				<div class="col-md-3">
		...
		<div id="paket_wrapper" class="block full row">
			<div class="block-title">
				...
				<h2><strong>Komposisi Produk</strong></h2>
			</div>
