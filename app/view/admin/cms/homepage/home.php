...
<div id="page-content">
	...
	<div class="block full">
		<div class="block-title">
			...
			<h2><strong>Slider option <small></small></strong></h2>
		</div>
		<div class="row" style="margin-bottom: 1em; padding-bottom: 1em; border-bottom: 1px #ededed solid;">
			<div class="col-md-9">Resolusi Gambar 1280x640px</div>
			<div class="col-md-3">
		...
		<div id="slider_items" class="row media-manager">
			<?php $imgs = array(); if(strlen($homepage_data->slider_list)>2) $imgs = explode(",",$homepage_data->slider_list); $imgs_max = count($imgs); if(is_array($imgs) && $imgs_max){ $i=0; foreach($imgs as $im){ ?>
