				...
				<form id="ftambah" action="<?php echo base_url_admin(); ?>" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" onsubmit="return false;">
					<fieldset>
						<div class="form-group">
							<div class="col-md-6">
                <label class="" for="iprovinsi" >Provinsi</label>
								<select id="iprovinsi" class="form-control" >
                  ...
                  <?php }?>
							...
							<div class="col-md-6">
                <label class="" for="ikabkota_id" >Kabupaten/Kota ID</label>
								<select id="ikabkota_id" name="kabkota_id" class="form-control" >
                  ...
                  <?php }?>
						...
						<div class="form-group">
							<div class="col-md-6">
								<label class="" for="inama_kecamatan" >Nama Kecamatan*</label>
								<input id="inama_kecamatan" type="text" name="nama_kecamatan" class="form-control" minlength="1" placeholder="" required />
							</div>
						</div>
						<div class="form-group">
							<div class="col-md-6">
			...
			<div class="modal-body">
				<form id="fedit" action="<?php echo base_url_admin(); ?>" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" onsubmit="return false;">
					<fieldset>
						<div class="form-group">
							<div class="col-md-6">
                <label class="" for="ieprovinsi" >Provinsi</label>
								<select id="ieprovinsi" class="form-control" >
                  <?php foreach($provinsi as $p) { ?>
                  ...
                  <?php }?>
							...
							<div class="col-md-6">
                <label class="" for="iekabkota_id" >Kabupaten/Kota ID</label>
								<select id="iekabkota_id" name="kabkota_id" class="form-control" >
                  <?php foreach($kabkota as $k) { ?>
                  ...
                  <?php }?>
						...
						<div class="form-group">
							<div class="col-md-6">
								<label class="" for="ienama_kecamatan" >Nama Kecamatan*</label>
								<input id="ienama_kecamatan" type="text" name="nama_kecamatan" class="form-control" minlength="1" placeholder="" required />
							</div>
						</div>
						<div class="form-group">
							<div class="col-md-6">
