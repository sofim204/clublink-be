...
<div id="page-content">
		...
		<div class="col-md-5">
			...
			<div class="block">
					...
					<div class="block-title">
						<h2><i class="fa fa-user"></i> Seller <strong>Profile</strong></h2>
					</div>
      ...
      <div class="block">
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="row push">
              <div class="col-xs-6">
                <h3><strong id="seller-sales-total" class="animation-fadeInQuick">$ 1.200,00</strong><br><small class="text-uppercase animation-fadeInQuickInv"><a href="javascript:void(0)">Total Sales</a></small></h3>
              </div>
              <div class="col-xs-6">
                <h3><strong id="seller-order-count" class="animation-fadeInQuick">45.000</strong><br><small class="text-uppercase animation-fadeInQuickInv"><a href="javascript:void(0)">Total Orders</a></small></h3>
              </div>
              <div class="col-xs-6">
                <h3><strong id="seller-confirmed-count" class="animation-fadeInQuick">1.520.000</strong><br><small class="text-uppercase animation-fadeInQuickInv"><a href="javascript:void(0)">Confirmed Order</a></small></h3>
              </div>
              <div class="col-xs-6">
                <h3><strong id="seller-rejected-count" class="animation-fadeInQuick">28.000</strong><br><small class="text-uppercase animation-fadeInQuickInv"><a href="javascript:void(0)">Rejected Order</a></small></h3>
              </div>
              <div class="col-xs-6">
                <h3><strong id="seller-product-count" class="animation-fadeInQuick">3.5%</strong><br><small class="text-uppercase animation-fadeInQuickInv"><a href="javascript:void(0)">Product Count</a></small></h3>
              </div>
              <div class="col-xs-6">
                <h3><strong id="seller-freeproduct-count" class="animation-fadeInQuick">4.250</strong><br><small class="text-uppercase animation-fadeInQuickInv"><a href="javascript:void(0)">Free Product Count</a></small></h3>
              </div>
            </div>
          </div>
        </div>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="block">
        <div class="block-title">
          <h2><i class="fa fa-dropbox"></i> Products <strong></strong></h2>
        </div>
        <div class="row">
          <div class="col-md-12">
