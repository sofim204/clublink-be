...
<div id="page-content">
	...
	<div class="block block-full">
			...
			<div class="col-md-6">
				<table class="table table-borderless table-striped">
					<tr>
						...
						<td class="col-md-1">:</td>
						<td><?=$produk->stok?> <?=$produk->satuan ? $produk->satuan : ""?></td>
					</tr>
					<tr>
		...
		<div class="row">
			<div class="col-md-12">
				...
				<div class="std" style="margin-bottom: 10px;">
	...
	<!-- product video-->
	<div id="product_video" class="block block-full">
		<div class="block-title">
			<h2><strong>Product Video [<?= $total_video; ?> Video and <?= $total_uploading_image; ?> Uploading Image]</strong></h2>
		</div>
		<div class="block-section">
			<div class="row">
				<?php foreach ($produk->videos as $video) {
					// $filedata = $video->url;
					// $fileext = strtolower(pathinfo($filedata, PATHINFO_EXTENSION));
					// if($fileext == "mp4" || $fileext == "mov") {
					$filetype = $video->jenis;
					if($filetype == "video") {
				?>
					<div class="col-md-4">
						<?php 
					...
					<!-- <div class="col-md-2">
						<button type="button" id="" class="btn btn-primary">Change Video</button>
					</div>
					<div class="col-md-1">
						<button type="button" id="" class="btn btn-danger">Takedown Video</button>
					</div> -->
				<?php } else {} } ?>
			</div>
		</div>
		...
		<div class="col-md-6">
			<div class="block">
				...
				<div class="row">
					...
					<div class="col-md-6">
						<img id="userImage" src="<?=base_url($user->image)?>" class="img-responsive" style="width:50%" onerror="this.onerror=null;this.src='<?=base_url()?>media/default.png';" />
					</div>
					<div class="col-md-3">&nbsp;</div>
				</div>
