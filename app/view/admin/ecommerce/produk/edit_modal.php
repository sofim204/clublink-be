	...
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<form id="image_upload_modal_form" action="<?=base_url_admin("ecommerce/produk/gambar_tambah/".$produk->id)?>" method="post">
...
<div id="user_search_modal" class="modal fade " tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
						<form id="user_search_modal_form" action="<?=base_url_admin("ecommerce/produk/baru/")?>" method="post">
							<div class="form-group">
								<div class="col-md-12">
									<div class="input-group">
