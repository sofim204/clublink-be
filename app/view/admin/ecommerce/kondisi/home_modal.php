					...
					<fieldset>
						<div class="form-group">
							<div class="col-md-12">
								...
								<input id="inama" type="text" name="nama" class="form-control" placeholder="Name of Value" maxlength="25" required />
							</div>
						</div>
						<div class="form-group">
							<div class="col-md-12">
								<label class="control-label" for="inilai">Value *</label>
								<input id="inilai" type="text" name="nilai" class="form-control" placeholder="Real Value, e.g: Very Good Conditions" required />
							</div>
						</div>
						<div class="form-group">
							<div class="col-md-4">
								<label class="control-label" for="iprioritas">Priority * <small>1 = top</small></label>
								<input id="iprioritas" min="1" max="5" name="prioritas" type="number" class="form-control" value="1" />
							</div>
							<div class="col-md-4">
					...
					<fieldset>
						<div class="form-group">
							<div class="col-md-12">
								...
								<input id="ienama" type="text" name="nama" class="form-control" placeholder="Name of Value" maxlength="25" required />
							</div>
						</div>
						<div class="form-group">
							<div class="col-md-12">
						...
						<div class="form-group">
							<div class="col-md-4">
								...
								<input id="ieprioritas" min="1" max="5" name="prioritas" type="number" class="form-control" value="1" />
							</div>
							<div class="col-md-4">
