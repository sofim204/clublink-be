			...
			<div class="modal-body">
				<div class="row">
					<div class="col-xs-12 btn-group-vertical " style="text-align: left;">
						...
						<a id="aprint_packing_list" href="#" class="btn btn-info text-left">
							<i class="fa fa-print"></i> Print Packing List
						</a>
						<a id="aprint_faktur" href="#" class="btn btn-info text-left">
