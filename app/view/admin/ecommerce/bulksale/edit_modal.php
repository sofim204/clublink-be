<!-- modal upload image -->
<div id="image_upload_modal" class="modal fade " tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<form id="image_upload_modal_form" action="<?=base_url_admin("ecommerce/bulksale/gambar_tambah/".$produk->id)?>" method="post">
						<div class="form-group">
							<div class="col-md-12">
								<div class="input-group">
									<input id="image_upload_modal_input" name="image" type="file" class="form-control" required />
								</div>
							</div>
						</div>
						<div class="form-group">
							<div class="col-md-12">
								<div class="btn-group pull-right">
									<button id="image_upload_modal_form_btn" type="submit" class="btn btn-success"><i class="fa fa-upload"></i> Upload</button>
								</div>
							</div>
						</div>
					</form>
...
<div id="user_search_modal" class="modal fade " tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
						<form id="user_search_modal_form" action="<?=base_url_admin("ecommerce/bulksale/baru/")?>" method="post">
							<div class="form-group">
								<div class="col-md-12">
									<div class="input-group">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div id="modalBody" class="modal-body">
				...
				<form id="modal_media_add_form" method="post" action="<?=base_url("api_admin/cms/media/add/"); ?>" style="display:none;"  class="form-horizontal" onsubmit="return false;">
