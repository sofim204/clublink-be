				...
				<form id="ftambah" action="<?=base_url_admin(); ?>" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" onsubmit="return false;">
					<fieldset>
						<div class="form-group">
							<div class="col-md-12">
								<label class="control-label" for="iuserid">b_user_id</label>
								<input id="iuserid" type="number" name="b_user_id" class="form-control" required/>
							</div>
							<div class="col-md-12">
								<label class="control-label" for="ikeyword_text">Keyword Text *</label>
				...
				<form id="fedit" action="<?=base_url_admin(); ?>" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" onsubmit="return false;">
					<fieldset>
						...
						<div class="form-group">
							...
							<div class="col-md-12">
								<label class="control-label" for="ieuserid">b_user_id</label>
								<input id="ieuserid" type="number" name="b_user_id" class="form-control" required/>
							</div>
							<div class="col-md-12">
