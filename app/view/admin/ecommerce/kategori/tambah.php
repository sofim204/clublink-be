	...
	<form id="ftambah" action="<?=base_url_admin(); ?>" method="post" enctype="multipart/form-data" class="" onsubmit="return false;">
		<div class="block full row">
			...
			<div class="form-group">
				<div class="col-md-6">
					...
					<input id="inama" type="text" name="nama" class="form-control" minlength="1" placeholder="Category Name" required />
				</div>
				<div class="col-md-6">
					<label class="" for="iindonesia">Name Indo*</label>
					<input id="iindonesia" type="text" name="indonesia" class="form-control" minlength="1" placeholder="Nama Kategori" required />
				</div>
			</div>
		</div>
		...
		<div class="block full row">
			...
			<div class="form-group">
				...
				<div class="col-md-3">
					<label for="iis_fashion">Is Fashion</label>
					<select id="iis_fashion" name="is_fashion" class="form-control">
