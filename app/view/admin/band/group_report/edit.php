	...
	<form id="fedit" action="<?=base_url_admin(); ?>" method="post" enctype="multipart/form-data" class="" onsubmit="return false;">
		<div class="block full row">
			...
			<div class="form-group">
				...
				<div class="col-md-4">
					<label class="" for="iekorea">Korea *</label>
					<input id="iekorea" type="text" name="korea" class="form-control" minlength="1" placeholder="Korea" autocomplete="off" required />
				</div>
				<div class="col-md-4">
					<label class="" for="iethailand">Thailand *</label>
					<input id="iethailand" type="text" name="thailand" class="form-control" minlength="1" placeholder="Thailand" autocomplete="off" required />
				</div>
			</div>	
		</div>
