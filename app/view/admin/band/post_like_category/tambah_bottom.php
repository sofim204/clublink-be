...
$("#ftambah").on("submit",function(e){
	...
	var url = '<?=base_url("api_admin/band/post_like_category/tambah/"); ?>';
	...
	$.ajax({
		...
		success: function(respon){
			...
			if(respon.status==200){
				gritter('<h4>Success</h4><p>New category successfully added</p>','success');
				setTimeout(function(){
					window.location = '<?=base_url_admin('band/post_like_category/')?>';
				},500);
			}else{
