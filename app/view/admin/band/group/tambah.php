	...
	<form id="ftambah" action="<?=base_url_admin(); ?>" method="post" enctype="multipart/form-data" class="" onsubmit="return false;">
		<div class="block full row">
			...
			<div class="form-group">
				<div class="col-md-12">
					<label class="" for="inama">Name (English) *</label>
				...
				<div class="col-md-4">
					<label class="" for="ikorea">Korea *</label>
					<input id="ikorea" type="text" name="korea" class="form-control" minlength="1" placeholder="Korea" autocomplete="off" required />
				</div>
				<div class="col-md-4">
					<label class="" for="ithailand">Thailand *</label>
					<input id="ithailand" type="text" name="thailand" class="form-control" minlength="1" placeholder="Thailand" autocomplete="off" required />
				</div>
			</div>
		</div>
