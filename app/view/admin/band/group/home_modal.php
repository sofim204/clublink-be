			...
			<div class="modal-body">
				<div class="row">
					<div class="col-xs-12 btn-group-vertical " style="text-align: left;">
						<a id="adetail" href="#" class="btn btn-info text-left" target="_blank"><i class="fa fa-info-circle"></i> Detail</a>
						<a id="breport" href="#" class="btn btn-warning text-left"><i class="fa fa-exclamation-triangle"></i> Report</a>
