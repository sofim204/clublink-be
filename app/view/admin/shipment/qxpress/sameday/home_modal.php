	...
	<div class="modal-dialog">
		<div class="modal-content">
            ...
            <div class="form-group">
							<div class="col-md-12">
								<label class="" for="iweight_max" >weight max (KG)*</label>
								<input id="iweight_max" type="text" name="weight_max" class="form-control" minlength="1" placeholder="" required />
							</div>
              <div class="col-md-12">
                <label class="" for="idistance_max" >distance max (m)*</label>
                <input id="idistance_max" type="number" name="distance_max" class="form-control" minlength="1" placeholder="" required />
              </div>
							<div class="col-md-12">
	...
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<div class="modal-body">
	            ...
	            <div class="form-group">
								<div class="col-md-12">
									<label class="" for="ieweight_max" >weight max (KG)*</label>
									<input id="ieweight_max" type="text" name="weight_max" class="form-control" minlength="1" placeholder="" required />
								</div>
	              <div class="col-md-12">
	                <label class="" for="iedistance_max" >distance max (m)*</label>
	                <input id="iedistance_max" type="number" name="distance_max" class="form-control" minlength="1" placeholder="" required />
	              </div>
								<div class="col-md-12">
