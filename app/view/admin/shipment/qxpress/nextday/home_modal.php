	...
	<div class="modal-dialog">
		<div class="modal-content">
            ...
            <div class="form-group">
              <div class="col-md-8">
                <label class="" for="iweight" >Weight *</label>
                <input id="iweight" type="number" step="0.01" name="weight" class="form-control" minlength="1" placeholder="" required />
              </div>
							<div class="col-md-4">
								<label class="" for="iweightunit" >Weight Unit*</label>
								<input id="iweightunit" type="text" name="weight_unit" class="form-control" minlength="1" maxlength="2" placeholder="" required />
							</div>
							<div class="col-md-12">
			...
			<div class="modal-body">
				<form id="fedit" action="<?=base_url_admin(); ?>" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" onsubmit="return false;">
					<fieldset>
						...
						<div class="form-group">
              <div class="col-md-8">
                <label class="" for="ieweight" >Weight *</label>
                <input id="ieweight" type="number" step="0.01" name="weight" class="form-control" minlength="1" placeholder="" required />
              </div>
							<div class="col-md-4">
								<label class="" for="ieweightunit" >Weight Unit*</label>
								<input id="ieweightunit" type="text" name="weight_unit" class="form-control" minlength="1" maxlength="2" placeholder="" required />
							</div>
							<div class="col-md-12">
