...
<div id="page-content">
  ...
  <ul class="breadcrumb breadcrumb-top">
    <li>Admin</li>
    <li>CRM</li>
    <li><a href="<?=base_url_admin("crm/chat_admin/")?>">Chat Room Admin</a></li>
    <li>Detail</li>
    <li><?= '#'.$chat_room_id ;?></li>
    <li><?= $chat_type; ?></li>
  </ul>
  ...
  <div class="row">
    ...
    <div class="col-md-12">
      ...
      <div class="block scroll-chat" id="scroll-chat-down">
        ...
        <div class="block-title">
          <h2><i class="fa fa-wechat"></i> Chat Admin</h2>
        </div>
                        ...
                        <div class="col-md-4">
                          <table class="tabel">
                            <tr>
                              ...
                              <td class="">:</td>
                              <td><?= $this->__st($chat_room->b_user_fnama_1) ?></td>
                            </tr>
                          </table>
                        </div><!-- end col-md-4 -->
                        <div class="col-md-4">
                          <table class="tabel">
                            <tr>
                              <th class="">Chat Follower</th>
                              <td class="">:</td>
                              <td><?= $this->__st($chat_room->b_user_fnama_2) ?></td>
                            </tr>
                          </table>
                        </div><!-- end col-md-4 -->
                        <div class="col-md-4">
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="btn-group pull-right">
          <a href="<?=base_url_admin("crm/chat_admin/detail/$chat_room_id/ADMIN/$chat_room->b_user_id_2/")?>" class="btn btn-danger"><i class="fa fa-wechat"></i> Chat With <?= $chat_room->b_user_fnama_2 ?></a>
        </div>
      </div>
          ...
          <div class="caption">
            ...
            <form id="fsendchat" action="<?=base_url_admin(); ?>" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" onsubmit="return false;">
              ...
              <div class="form-group">
                ...
                <div class="col-md-6">
                  <label>
                    <span class="text-danger" style="font-size: 12px; text-decoration: underline;">Attach <?= $chat_room->b_user_fnama_2 ?>'s Product</span>
                  </label>
                ...
                <div class="col-md-6">
                  <label>
                    <span class="text-danger" style="font-size: 12px; text-decoration: underline;">Attach <?= $chat_room->b_user_fnama_2 ?>'s Invoice (Buyer)</span>
                  </label>
                ...
                <div class="col-md-6">
                  <label>
                    <span class="text-danger" style="font-size: 12px; text-decoration: underline;">Attach <?= $chat_room->b_user_fnama_2 ?>'s Invoice (Seller)</span>
                  </label>
