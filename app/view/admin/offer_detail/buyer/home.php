...
<div id="page-content">
	...
	<ul class="breadcrumb breadcrumb-top">
		<li>Admin</li>
		<li>Misc</li>
		<li>Offer Detail Buyer</li>
	</ul>

	<div class="block full">
		<div class="block-title">
			<h2><strong>Offer Detail Buyer</strong></h2>
		</div>
		<div class="block-section">
			...
			<div class="row" style="margin-top: 10px;">
				<div class="col-md-2">
					<label for="buyer_name_offer">Name </label>
					<div class="input-group">
						<div class="input-group-addon">
							<i class="fa fa-user"></i>
						</div>
						<input id="buyer_name_offer" type="text" class="form-control" value="<?=$buyer_name_offer->fnama?>" readonly />
					</div>
				</div>
				<div class="col-md-2">
					<label for="buyer_type_offer">Type </label>
					<div class="input-group">
						<div class="input-group-addon">
							<i class="fa fa-user"></i>
						</div>
						<input id="buyer_type_offer" type="text" class="form-control" placeholder="buyer/seller" value="<?=$toggle_buyer?>" readonly />
					</div>
				</div>
				<div class="col-md-2" style="display: none;">
					<label for="buyer_type_offer">Buyer ID </label>
					<div class="input-group">
						<div class="input-group-addon">
							<i class="fa fa-user"></i>
						</div>
						<input id="id_buyer_type_offer" type="text" class="form-control" value="<?=$id_buyer?>" readonly />
					</div>
				</div>
			</div>
		</div>
