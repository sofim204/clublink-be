			...
			<div class="modal-body">
				<div class="row">
					<div class="col-xs-12 btn-group-vertical " style="text-align: left;">
						...
						<a id="aignore" href="#" class="btn btn-warning text-left" style="display: none;"><i class="fa fa-check-circle"></i> Ignore</a>
						<!-- <div style="margin-bottom: 8px;"></div> -->
						<a id="atakedown" href="#" class="btn btn-danger text-left"><i class="fa fa-arrow-down"></i> Takedown</a>
					</div>
				</div>
