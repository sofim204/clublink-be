			...
			<div class="modal-body">
				<form id="fedit" action="<?=base_url_admin(); ?>" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" onsubmit="return false;">
					<fieldset>
						...
						<div class="form-group">
							<div class="col-md-12">
								<label class="" for="ienama">Nama Kategori</label>
...
<!-- modal cover change -->
<div id="modal_cover_change" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			<!-- Modal Header -->
			<div class="modal-header modal-header-title text-center">
				<a href="javascript:void(0)" data-dismiss="modal" class="pull-right modal-dismiss"><strong><i class="fa fa-times"></i></strong></a>
				<h2 class="modal-title"><strong>Change Cover</strong></h2>
			</div>
			<!-- END Modal Header -->

			<!-- Modal Body -->
			<div class="modal-body">
				<form id="fcover_change" action="<?=base_url_admin(); ?>" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" onsubmit="return false;">
					<fieldset>
						<div class="form-group">
							<div class="col-md-12">
								<label class="" for="ieimage_icon">Choose Cover File * <small>128px x 128px</small></label>
								<input id="ieimage_cover" type="file" name="image_cover" class="form-control" accept="image/x-png,image/jpeg,image/jpg"  required />
							</div>
						</div>
					</fieldset>
					<div class="form-group form-actions">
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-xs-12 btn-group-vertical " style="text-align: left;">
						...
						<a id="acover_change" href="#" class="btn btn-info text-left"><i class="fa fa-image"></i> Change Cover</a>
