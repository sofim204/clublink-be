...
<div id="page-content">
		...
		<div class="row" style="padding: 0.5em 2em;">
			...
			<div class="col-md-6">
				<div class="btn-group pull-right">
					<a id="" href="<?=base_url_admin('community/category/add_new/')?>" class="btn btn-info"><i class="fa fa-plus"></i> New</a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="block full">
		...
		<div class="block-title">
			<h2><strong>Community Categories</strong></h2>
		</div>
			...
			<table id="drTable" class="table table-vcenter table-condensed table-bordered" width="100%">
				<thead>
					<tr style="background-color: #FFFFFF;">
						...
						<th width="600px">Description Indonesia</th>
						<th>Priority</th>
						<th>Priority Indo</th>
						<th>Is Active?</th>
					</tr>
