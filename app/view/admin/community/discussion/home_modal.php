			...
			<div class="modal-body">
				<div class="row">
					<div class="col-xs-12 btn-group-vertical " style="text-align: left;">
						...
						<!-- <a id="areport" href="#" class="btn btn-danger text-left"><i class="fa fa-pencil"></i> Report</a> -->
						<a id="aicon_change" href="#" class="btn btn-info text-left" style="display:none;"><i class="fa fa-image"></i> Change Icon</a>
						<button id="bhapus" type="button" class="btn btn-danger text-left" style="display:none;"><i class="fa fa-trash-o"></i> Delete</button>
					</div>
				</div>
