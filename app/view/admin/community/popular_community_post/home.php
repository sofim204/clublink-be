...
<div id="page-content">
		...
		<div class="row" style="padding: 0.5em 2em;">
			...
			<div class="col-md-6">
				<div class="btn-group pull-right">
					<button id="button_add_to_popular_community_homepage" type="button" class="btn btn-info text-left"><i class="fa fa-info-circle"></i> Add To Popular Community</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="block full">
		<div class="block-title">
			<h2><strong>Popular Community Post</strong></h2>
		</div>
	...
	<!-- END Content -->
	<div class="container_change_and_reorder_popular_community">
