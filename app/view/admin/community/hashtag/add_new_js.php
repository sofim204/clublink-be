...
$("#ftambah").on("submit",function(e){
	...
	var url = '<?=base_url("api_admin/community/hashtag/tambah/"); ?>';
	...
	$.ajax({
		...
		success: function(respon){
			...
			if(respon.status==200){
				gritter('<h4>Success</h4><p>New hashtag successfully added</p>','success');
				setTimeout(function(){
					window.location = '<?=base_url_admin('community/hashtag/')?>';
				},1000);
			}else{
