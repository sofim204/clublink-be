			...
			<div class="modal-body">
				<form id="ftambah" action="<?=base_url_admin()?>" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" onsubmit="return false;">
					<fieldset>
            			<div class="form-group">
							<div class="col-md-6">
								...
								<div class="input-group">
									...
									<span class="input-group-btn">
										<button type="button" class="btn btn-default btn-cari-bank" data-for="from"><i class="fa fa-search"></i></button>
									</span>
								</div>
							...
							<div class="col-md-6">
								...
								<div class="input-group">
									...
									<span class="input-group-btn">
										<button type="button" class="btn btn-default btn-cari-bank" data-for="to"><i class="fa fa-search"></i></button>
									</span>
								</div>
            			...
            			<div class="form-group">
							<div class="col-md-6">
								<label class="" for="iutype">Unit</label>
								<select id="iutype" name="utype" class="form-control">
									<option value="nominal">Fixed Cost</option>
		...
		<div class="modal-content">
            ...
            <div class="form-group">
							<div class="col-md-6">
								<label class="" for="ia_bank_id_from" >From Bank</label>
								<div class="input-group">
									<input id="iea_bank_nama_from" type="text" class="form-control" placeholder="Search Bank" disabled />
									<span class="input-group-btn">
                    <button type="button" class="btn btn-default btn-cari-bank" data-for="from"><i class="fa fa-search"></i></button>
                  </span>
								</div>
								<input id="iea_bank_id_from" name="a_bank_id_from" type="hidden" class="form-control" minlength="1" placeholder="" />
							</div>
							<div class="col-md-6">
								<label class="" for="ia_bank_id_to" >To Bank</label>
								<div class="input-group">
									<input id="iea_bank_nama_to" type="text" class="form-control" placeholder="Search Bank" disabled />
									<span class="input-group-btn">
                    <button type="button" class="btn btn-default btn-cari-bank" data-for="to"><i class="fa fa-search"></i></button>
                  </span>
								</div>
								<input id="iea_bank_id_to" name="a_bank_id_to" type="hidden" class="form-control" minlength="1" placeholder="" />
							</div>
						</div>
            <div class="form-group">
							<div class="col-md-6">
