	...
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header text-center">
				<h2 class="modal-title">Add Multi Language</h2>
			</div>
...
<div id="modal_edit" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header text-center">
				<h2 class="modal-title">Edit UDID</h2>
			</div>
			<div class="modal-body">
					...
					<fieldset>
						...
						<div class="form-group">
							<div class="col-md-12">
								...
								<label class="control-label" for="ieudid">UDID</label>
								<input type="text" name="ui_id" id="ieudid" class="form-control" autocomplete="off" />
							</div>
						</div>
						<div class="form-group">
							<div class="col-md-12">
								<label class="control-label" for="iename">Name</label>
								<input type="text" name="nama" id="iename" class="form-control" autocomplete="off" />
							</div>
						</div>
					</fieldset>
					<div class="form-group form-actions">
