			...
			<div class="modal-body">
				<div class="row">
					<div class="col-xs-12 btn-group-vertical ">
						<a id="adetail" href="#" class="btn btn-info text-left" style="text-align: left;"><i class="fa fa-list"></i> Detail</a>
						<a id="aedit" href="#" class="btn btn-info text-left" style="text-align: left;"><i class="fa fa-pencil"></i> Edit</a>
						<a id="aedit_password" href="#" class="btn btn-info text-left" style="text-align: left;"><i class="fa fa-asterisk"></i> Change Password</a>
