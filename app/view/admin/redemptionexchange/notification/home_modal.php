				...
				<div class="row" style="margin-top: 1em; ">
					...
					<center>
						<div class="col-xs-12 btn-group-horizontal">
							<button id="b_success" type="button" class="btn btn-info text-left mb-8px"><i class="fa fa-check-circle"></i> Success</button>
							<button id="b_problem" type="button" class="btn btn-danger text-left mb-8px"><i class="fa fa-times-circle"></i> Top Up Problem</button>
							<button id="b_refund" type="button" class="btn btn-warning text-left mb-8px"><i class="fa fa-exchange"></i> Refund Wallet</button>
						</div>
					</center>
...
||                                                                 ||
================================================================= -->
<div id="modal_success_option" class="modal fade " tabindex="-1" role="dialog" aria-hidden="true">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">

			<!-- Modal Header -->
			<div class="modal-header modal-header-title text-center">
				<h2 class="modal-title"><strong>Choose Success Reason : </strong></h2>
			</div>
			<!-- END Modal Header -->
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-xs-12 btn-group-vertical" style="text-align: left;">
						...
						<button id="b_success_option_1" type="button" class="btn btn-info text-left mb-8px"><i class="fa fa-times-circle"></i> Congratulations! Redemption has been completed successfully <br><i>(Selamat, Redeem telah berhasil.)</i></button>
						<button id="b_success_option_2" type="button" class="btn btn-warning text-left mb-8px"><i class="fa fa-times-circle"></i> Sorry, you can only top up 10.000 rupiah as a Smartfren user.
                        Sellon will return 1.000 SPT to you today <br><i>(Maaf, Kamu hanya bisa top up 10.000 rupiah sebagai pengguna Smartfren. Sellon akan mengembalikan 1.000 SPT ke kamu hari ini)</i></button>
					</div>
				</div>
				<div class="row" style="margin-top: 1em; ">
					<div class="col-md-12" style="border-top: 1px #afafaf dashed;">&nbsp;</div>
