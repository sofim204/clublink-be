...
<div id="page-content">
	...
	<div class="block full">
		...
		<div class="block-title">
			<h2><strong>Ready for Agent List</strong></h2>
		</div>
		<div class="row">
<!-- 			<div class="col-md-4">&nbsp;</div> -->
			...
			<div class="col-md-3">
				...
				<select id="ifstatus" class="form-control">
					...
					<option value="1">Ongoing (Balance Deducted)</option>
					<option value="2">Fail (Top-Up Problem)</option>
					<option value="3">Fail (Balance Refunded)</option>
				</select>
			</div>
			<div class="col-md-1">
			...
			<div class="col-md-1">
				...
				<button id="bdownload_xls" class="btn btn-success btn-block"><i class="fa fa-download"></i> Export</button>
			</div>
			<div class="col-md-2">
				<label class="if_action">&nbsp;</label>
