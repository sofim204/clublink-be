...
<div id="page-content">
		...
		<div class="row" style="padding: 0.5em 2em;">
			...
			<div class="col-md-6">
				<div class="btn-group pull-right">
					<a id="" href="<?=base_url_admin('redemptionexchange/type/tambah/')?>" class="btn btn-info"><i class="fa fa-plus"></i> New</a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="block full">
		...
		<div class="block-title">
			<h2><strong>Redemption Exchange Setting</strong></h2>
		</div>
