<?php
class H_Ticket_Shop_Model extends SENE_Model {
	var $tbl = 'h_ticket_shop';
	var $tbl_as = 'hts';
	...
	public function getAll($nation_code, $page=0, $pagesize=10, $sortCol="cdate", $sortDir="", $keyword="", $utype_in=array()) {
		...
		$this->db->select_as("$this->tbl_as.earned_ticket", "earned_ticket", 0);
		...
		if(mb_strlen($keyword)>0) {
			$this->db->where_as("$this->tbl_as.earned_ticket", addslashes($keyword), "OR", "%like%", 0, 0);
		}
