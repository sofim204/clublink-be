...
class B_User_ProductWanted_Model extends JI_Model
{
    ...
    //     return $this->db->get_first();
    // }
    public function getWanteds($nation_code, $keyword_text, $b_user_id_seller)
    {
        ...
        $this->db->select_as("$this->tbl2_as.language_id", "b_user_language_id", 0);
        ...
        $this->db->where_as("$this->tbl_as.nation_code", $this->db->esc($nation_code));
        $this->db->where_as("$this->tbl2_as.id", $this->db->esc($b_user_id_seller),"AND","!=");
