<?php
class G_Check_In_Setting_Model extends JI_Model
{
    public $tbl = 'g_check_in_setting';
    public $tbl_as = 'gcis';
    // public $tbl2 = 'b_user';
    // public $tbl2_as = 'bu';
    ...
    // public function countAll($nation_code, $dateCompare)
    // {
    ...
    //     $this->db->where_as("DATE($this->tbl_as.start_date)", $this->db->esc($dateCompare),"AND","<=");
    //     $this->db->where_as("DATE($this->tbl_as.end_date)", $this->db->esc($dateCompare),"AND",">=");
    ...
    public function getOldest($nation_code, $dateCompare="")
    {
        ...
        $this->db->order_by("$this->tbl_as.start_date", "ASC");
...
//     }
    ...
    // public function checkAlreadyInDB($nation_code, $postal_district, $b_user_id, $custom_id, $custom_type, $custom_type_sub)
    // {
    //     $this->db->select_as("$this->tbl_as.b_user_id", "b_user_id", 0);
    //     $this->db->select_as("$this->tbl_as.b_user_alamat_location_postal_district", "postal_district", 0);
