<?php
class C_Community_Hashtag_History_Model extends JI_Model
{
    public $tbl = 'c_community_hashtag_history';
    public $tbl_as = 'cchh';
    ...
    public function getByUseridHashtag($nation_code, $b_user_id, $hashtag, $is_double_spt="", $date="")
    {
        // $this->db->select_as("$this->tbl_as.id", "id", 0);
        ...
        if($is_double_spt != ""){
            $this->db->where_as("$this->tbl_as.is_double_spt", $this->db->esc($is_double_spt));
        }
        if($date != ""){
