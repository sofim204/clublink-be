<?php
class H_Point_Redemption_Exchange_History_Model extends JI_Model
{
    public $tbl = 'h_point_redemption_exchange_history';
    public $tbl_as = 'hpreh';
    // public $tbl2 = 'b_user';
    // public $tbl2_as = 'bu';
    ...
    {
        $this->db->where_as("nation_code", $this->db->esc($nation_code));
        $this->db->where_as("h_point_redemption_exchange_id", $this->db->esc($id));
    ...
    public function getAll($nation_code, $point_redemption_exchange_id)
    {
        ...
        $this->db->where_as("$this->tbl_as.nation_code", $this->db->esc($nation_code));
        $this->db->where_as("$this->tbl_as.h_point_redemption_exchange_id", $this->db->esc($point_redemption_exchange_id));
        $this->db->where_as("$this->tbl_as.is_public", $this->db->esc(1));
