...
{
    public $tbl = 'c_homepage_main_popular';
    public $tbl_as = 'chmp';
    // public $tbl2 = 'b_user';
    // public $tbl2_as = 'bu';
    // public $tbl3 = 'c_community_attachment';
    // public $tbl3_as = 'cca';
    // public $tbl4 = 'c_community_fake_like';
    // public $tbl4_as = 'ccfl';
    ...
    //     $composites[] = $this->db->composite_create("$this->tbl_as.id", "=", "$this->tbl3_as.c_community_id");
    //     return $composites;
    // }
    ...
    public function getAll($nation_code, $type)
    {
        ...
        $this->db->between($this->db->esc(date("Y-m-d")), "DATE($this->tbl_as.start_date)", "DATE($this->tbl_as.end_date)");
        $this->db->where_as("$this->tbl_as.is_active", $this->db->esc("1"));
