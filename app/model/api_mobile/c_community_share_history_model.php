<?php
class C_Community_Share_History_Model extends JI_Model {
  var $is_cacheable;
  var $tbl = 'c_community_share_history';
  var $tbl_as = 'ccsh';
  ...
  public function getLastId($nation_code,$c_community_id){
  ...
  public function countByCommunityidUserid($nation_code, $c_community_id, $b_user_id, $cdate=""){
    $this->db->select_as("COUNT(*)","total");
    $this->db->where("nation_code",$nation_code);
    $this->db->where("c_community_id",$c_community_id);
    $this->db->where("b_user_id",$b_user_id);
    if($cdate != ""){
      $this->db->where_as("DATE(cdate)",$this->db->esc($cdate));
    }
    $d = $this->db->get_first('',0);
  ...
  // public function getByCommunityidUserid($nation_code, $c_community_id, $b_user_id, $cdate=""){
  //   $this->db->where("nation_code",$nation_code);
  //   $this->db->where("c_community_id",$c_community_id);
  //   $this->db->where("b_user_id",$b_user_id);
  //   if($cdate != ""){
  //     $this->db->where("DATE(cdate)",$cdate);
  //   }
