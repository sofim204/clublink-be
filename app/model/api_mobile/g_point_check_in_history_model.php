<?php
// class G_Point_Check_In_History_Model extends JI_Model
// {
//     public $tbl = 'g_point_check_in_history';
//     public $tbl_as = 'gpcih';
//     // public $tbl2 = 'b_user';
//     // public $tbl2_as = 'bu';
...
//     public function updateForCalculated($nation_code, $b_user_id, $dateCustom, $du)
//     {
//         if (!is_array($du)) {
//             return 0;
//         }
...
//         $this->db->where_as("MONTH($this->tbl.cdate)", date("n", strtotime($dateCustom)));
//         $this->db->where_as("YEAR($this->tbl.cdate)", date("Y", strtotime($dateCustom)));
//         return $this->db->update($this->tbl, $du, 0);
//     }
...
//     public function countAll($nation_code, $b_user_id, $monthCompare, $yearCompare, $plusorminus="+", $custom_type="check in", $custom_type_sub="daily")
//     {
...
//         $this->db->where_as("MONTH($this->tbl_as.cdate)", $this->db->esc($monthCompare));
//         $this->db->where_as("YEAR($this->tbl_as.cdate)", $this->db->esc($yearCompare));
...
//     public function getAll($nation_code, $b_user_id, $monthCompare, $yearCompare, $plusorminus="+", $custom_type="check in", $custom_type_sub="daily")
//     {
...
//     public function checkAlreadyInDB($nation_code, $b_user_id, $dateCompare, $plusorminus="+", $custom_type="check in", $custom_type_sub="daily")
//     {
//         $this->db->select_as("$this->tbl_as.id", "id", 0);
//         $this->db->select_as("$this->tbl_as.cdate", "cdate", 0);
...
//     public function getUserLoginOneMonth($nation_code, $dateCustom, $plusorminus="+", $custom_type="check in")
//     {
//         $this->db->select_as("$this->tbl_as.b_user_id", "b_user_id", 0);
//         $this->db->select_as("SUM($this->tbl_as.point)", "total_point", 0);
//         $this->db->from($this->tbl, $this->tbl_as);
...
//         $this->db->where_as("MONTH($this->tbl_as.cdate)", $this->db->esc(date("n", strtotime($dateCustom))));
//         $this->db->where_as("YEAR($this->tbl_as.cdate)", $this->db->esc(date("Y", strtotime($dateCustom))));
