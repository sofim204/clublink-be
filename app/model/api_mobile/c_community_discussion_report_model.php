<?php
class C_Community_Discussion_Report_Model extends JI_Model
{
    public $tbl = 'c_community_discussion_report';
    public $tbl_as = 'ccdr';
    public $tbl2 = 'b_user';
    public $tbl2_as = 'bu';
    ...
    // public function getbyParentDiscussionID($nation_code, $page=1, $page_size=10, $sort_col="cdate", $sort_direction="ASC", $parent_discussion_id=0, $product_id = 0)
    // {
    //     $this->db->exec("SET NAMES 'UTF8MB4'");
    //     $this->db->select_as("$this->tbl_as.*, $this->tbl_as.id", "discussion_id", 0);
    //     $this->db->select_as('COALESCE('.$this->__decrypt("$this->tbl2_as.fnama").',"")', "b_user_nama", 0);
    ...
    //     $this->db->join_composite($this->tbl2, $this->tbl2_as, $this->__joinTbl2(), 'left');
    //     $this->db->where_as("$this->tbl_as.nation_code", $this->db->esc($nation_code));
    //     $this->db->where_as("$this->tbl_as.id", $this->db->esc($parent_discussion_id));
    //     $this->db->where_as("$this->tbl_as.product_id", $this->db->esc($product_id));
    //     $this->db->where_as("$this->tbl_as.is_active", $this->db->esc('1'));
