<?php
class B_User_Alamat_Location_original_model extends JI_Model
{
    public $tbl = 'b_user_alamat_location_original';
    public $tbl_as = 'bualo';
    ...
    // public function getByUserIdNationCode($nation_code, $b_user_id)
    // {
    ...
    //     //by Donny Dennison - 16 july 2021 16:22
    //     //limit-address-to-5
    //     // $this->db->where_as("$this->tbl_as.nation_code", $negara->nation_code);
