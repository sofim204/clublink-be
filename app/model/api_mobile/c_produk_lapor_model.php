<?php
class C_Produk_Lapor_Model extends JI_Model{
	var $tbl = 'c_produk_lapor';
	var $tbl_as = 'cp';
	var $tbl2 = 'c_produk';
	var $tbl2_as = 'cp';
  ...
  public function checkTakeDown($nation_code,$c_produk_id){
    $this->db->where("nation_code",$nation_code);
    $this->db->where("c_produk_id",$c_produk_id);
		$this->db->where("status_teks","take down");
    return $this->db->get_first();
  }
