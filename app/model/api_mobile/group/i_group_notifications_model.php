<?php
class I_Group_Notifications_Model extends JI_Model
{
    public $tbl = 'i_group_notifications';
    public $tbl_as = 'ign';
	...
	public function getAll($nation_code,$b_user_id,$page=0,$pagesize=10,$sortCol="id",$sortDir="desc", $getType="all"){
		...
		$this->db->select_as("$this->tbl_as.group_name","group_name",0);
	...
	public function update($nation_code, $b_user_id, $notif_id = "", $du){
