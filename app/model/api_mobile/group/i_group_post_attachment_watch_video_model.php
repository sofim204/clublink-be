<?php
class I_Group_Post_Attachment_Watch_Video_Model extends JI_Model{

	var $tbl = 'i_group_post_attachment_watch_video';
	var $tbl_as = 'igpawv';
	...
	public function getByAttachmentIdUserIdType($nation_code, $i_group_post_attachment_id, $b_user_id, $type){
		$this->db->select_as("*,$this->tbl_as.id",'id',0);
		$this->db->from($this->tbl,$this->tbl_as);
		$this->db->where("nation_code",$nation_code);
		$this->db->where("i_group_post_attachment_id",$i_group_post_attachment_id);
