<?php
    ...
    parent::__construct();
		...
		$this->load("admin/c_community_event_new_user_model","ccenum");
	}
	public function index(){
		...
		$this->putThemeContent("event/daily_new_user/home_modal",$data);
		$this->putThemeContent("event/daily_new_user/home",$data);
		$this->putJsContent("event/daily_new_user/home_bottom",$data);
