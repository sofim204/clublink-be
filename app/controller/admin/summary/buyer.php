<?php
class Buyer extends JI_Controller{
  public function __construct(){
    parent::__construct();
    $this->setTheme("admin");
		$this->current_parent = 'summary';
		$this->current_page = 'summary_buyer';
  ...
  public function index($b_user_id=""){
    ...
    $this->setTitle("Buyer Summary ". $this->site_suffix_admin);
		$this->putThemeContent("summary/buyer/home_modal",$data);
		$this->putThemeContent("summary/buyer/home",$data);
		$this->putJsReady("summary/buyer/home_bottom",$data);
