<?php
	...
	public function __construct(){
		...
		$this->current_page = 'band_group_report';
	...
	public function index(){
		...
		$this->setTitle('Group Report '.$this->site_suffix_admin);
		...
		$this->putThemeContent("band/group_report/home_modal",$data);
		$this->putThemeContent("band/group_report/home",$data);
		$this->putJsContent("band/group_report/home_bottom",$data);
	...
	public function tambah(){
		...
		$this->putThemeContent("band/group_report/tambah_modal",$data);
		$this->putThemeContent("band/group_report/tambah",$data);


		$this->putJsContent("band/group_report/tambah_bottom",$data);
		$this->loadLayout('col-2-left',$data);
		$this->render();
	}
	...
	public function edit($id){
		...
		$this->putThemeContent("band/group_report/edit_modal",$data);
		$this->putThemeContent("band/group_report/edit",$data);
		$this->putJsContent("band/group_report/edit_bottom",$data);
		$this->loadLayout('col-2-left',$data);
		$this->render();
	}
	...
	public function detail_group_post($ieid){
		...
		$data['ieid'] = $ieid;
		$this->putThemeContent("band/group_report/detail_modal",$data);
		$this->putThemeContent("band/group_report/detail",$data);

		$this->putJsReady("band/group_report/detail_bottom",$data);
		$this->loadLayout('col-2-left',$data);
		$this->render();
	}
}