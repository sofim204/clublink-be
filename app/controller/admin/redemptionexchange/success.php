<?php
	class Success extends JI_Controller{
	...
	public function index(){
		...
		$this->setTitle('Redemption Exchange Success History '.$this->site_suffix_admin);
		...
		$this->putThemeContent("redemptionexchange/success/home_modal",$data);
		$this->putThemeContent("redemptionexchange/success/home",$data);
		$this->putJsContent("redemptionexchange/success/home_bottom",$data);
