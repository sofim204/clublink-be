...
class Create_Paid extends Runner_Controller
{
    ...
    private function __dataPayment($d_order_id)
    {
        ...
        $pd['payment_method'] = 'Credit Card';
        $pd['payment_status'] = 'paid';
        $pd['payment_date'] = '2020-04-14 10:55:30';
        $pd['payment_tranid'] = 'SM'.date("Ymd-His");
        $pd['payment_response'] = '{"version":"1.1","merchantID":"702702000000350","pan":"418238XXXXXX3177","userDefined1":"Buyer : Daeng Ozan 멋쟁이","userDefined2":"Product : Mask set","userDefined3":"","userDefined4":"","userDefined5":"","currencyCode":"SGD","recurringUniqueID":"","tranRef":"72264277","approvalCode":"407704","eci":"07","channelCode":"VI","agentCode":"UOBS","issuerCountry":"SG","respCode":"000","respDesc":"Success","amount":"000000001199","invoiceNo":"1586924556","cardToken":"08042010144001454013","referenceNo":"59059461","transactionDateTime":"20200415122244","signature":"E1810DAFF558098F0C4B1ED869F3C8ADD1A6C71C65B3A5FDF800F98F98B52FB5"}';
        $pd['payment_confirmed'] = "1";
        $pd['code_bank'] = strval(mt_rand(1, 7));
        $pd['code_bank'] = "1";
        return $pd;
    }
    ...
    public function index()
    {
        ...
        foreach ($this->order->sellers as $seller) {
            $this->__testCheckoutShipmentRate($seller->c_produk_id, 'Gogovan', 'Next Day');
        }
