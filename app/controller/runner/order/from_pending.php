...
class From_Pending extends Runner_Controller {
  var $nation_code = '65';
  var $apikey = 'kmz373ac';
  var $apisess = '65KMZDR';
  var $cart_products = '';
  ...
  private function __testOrderPendingList(){
    $this->__resetPage();
    $url = $this->url.'buyer/order/pending'.$this->url_page;
    $this->__vu("Order: Pending List",$url);
  ...
  public function index(){
    ...
    //open test
    $this->__vo("Order: From Pending -> Paid");

    //start call test procedure
    $this->__testOrderPendingList();
