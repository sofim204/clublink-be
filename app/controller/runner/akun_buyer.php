...
class Akun_Buyer extends Runner_Controller {
  ...
  public function index(){
    echo '<p></p><h3>Account: Buyer Runner / Unit Test</h3>';
    echo '<ul>';
    echo '<li><a href="'.base_url("runner/akun_buyer/list/").'">Order List</a></li>';
    echo '</ul>';
  }
