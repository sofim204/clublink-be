...
class Order extends Runner_Controller {
  ...
  public function index(){
    ...
    echo '<ul>';
    echo '<li><a href="'.base_url("runner/order/unpaid/").'">Create UnPaid</a></li>';
    echo '<li><a href="'.base_url("runner/order/payment_process/").'">Test Payment</a></li>';
    echo '<li><a href="'.base_url("runner/order/reject_by_seller/").'">Reject By Seller</a></li>';
    echo '<li><a href="'.base_url("runner/order/reject_by_buyer/").'">Reject By Buyer</a></li>';
    echo '<li><a href="'.base_url("runner/order/seller_delivered/").'">Delivered By Seller</a></li>';
    echo '<li><a href="'.base_url("runner/order/completed_test/").'">Completed Test Order (confirmed by Buyer)</a></li>';
    echo '</ul>';
  }
  ...
  public function payment_process(){
    ...
    $this->__vo("Order Test: After Payment / Forward to Seller");
  ...
  public function completed_test(){
    ...
    $this->__vo("Completed Test: Order");
  ...
  public function reject_by_seller(){
    ...
    $this->__vo("Order Test: Reject by Seller");
