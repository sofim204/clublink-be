...
class Reported_User extends JI_Controller {
    ...
    public function __construct() {
        parent::__construct();
        $this->lib("seme_log");
        $this->load("api_admin/b_reported_user_model", 'brum');
    }
    ...
    public function index() {
        ...
        switch ($iSortCol_0) {
            ...
            case 3:
                ...
                break;
            case 4:
                $sortCol = "reported_user_name";
                break;
            case 5:
                $sortCol = "reported_user_email";
                break;
            case 6:
                $sortCol = "deskripsi";
                break;
            case 7:
                $sortCol = "reported_date";
                break;
            default:
                $sortCol = "no";
        }
        ...
        $dcount = $this->brum->countAllReportedUser($keyword, $from_date, $to_date, $path);
        $ddata = $this->brum->getAllReportedUser($page, $pagesize, $sortCol, $sortDir, $keyword, $from_date, $to_date, $path);
