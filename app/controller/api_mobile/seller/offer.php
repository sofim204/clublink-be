...
class Offer extends JI_Controller
{
    ...
    public function index()
    {
        ...
        $data['offer_total'] = $this->ecrm->countAllForOfferList($nation_code, "offer", "seller", $pelanggan->id, $product_type, $type);

        $data['offer_list'] = $this->ecrm->getAllForOfferList($nation_code, "offer", "seller", $page, $page_size, $sort_col, $sort_dir, $pelanggan->id, $product_type, $type);
